...
void headerCreate(void)
{
  ...
  lv_obj_align(sym, NULL, LV_ALIGN_IN_RIGHT_MID,-20, -3);
...
void gaugeTemp()
{
  ...
  lv_obj_set_size(cont_Temp, 110, 100);
...
void gaugeHumi()
{
  ...
  lv_obj_set_size(cont_Humi, 110, 100);
...
void charGraph()
{
  ...
  lv_obj_set_size(chart, 230, 60);
  lv_obj_align(chart, NULL, LV_ALIGN_CENTER, 0,65);
